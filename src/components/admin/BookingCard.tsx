...
const BookingCard = ({ booking }: BookingCardProps) => {
 ...
 const handleStatusChange = (newStatus: string) => {
  ...
  return (
    <div 
      className="bg-barber-dark border border-barber-light-gray rounded-lg p-4 flex flex-col md:flex-row md:items-center gap-4"
    ...
    >
      ...
      <div className="flex items-center space-x-2 mt-2 md:mt-0">
        <a
          ...
          className="bg-barber-gray hover:bg-barber-orange hover:text-white transition-colors p-2 rounded-md"
